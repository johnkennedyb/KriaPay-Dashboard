...
<div className='mt-5  row  ' style={{ marginLeft:'70px',marginRight:'80px'}} >
  ...
  <div className='col-auto me-3'>
              ...
              <div className='col-auto me-3'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Bvn</p>
                <input
                  type="text"
              ...
              <div className='col-auto'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Nin</p>
                <input
                  type="text"
                  placeholder="2134578909"
...
<div className='mt-5  row  ' style={{ marginLeft:'70px',marginRight:'80px'}} >
  ...
  <img className='text-center' src="https://res.cloudinary.com/djx3ijal6/image/upload/v1722796616/Vector_21_trejqe.png"/>
  <div className='col-auto me-3'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Government Issued ID</p>
                <input
                  type="text"
                  placeholder="Nigeria"
              ...
              <div className='col-auto me-3'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Proof of Address</p>
                <input
                  type="text"
                  placeholder="Daniella willams"
              ...
              <div className='col-auto'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Selfie</p>
                <input
                  type="text"
                  placeholder="daniellawillams@gmail.com"
