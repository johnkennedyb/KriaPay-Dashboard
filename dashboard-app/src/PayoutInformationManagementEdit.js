...
<p style={{color:'#8ce5be' , marginTop:'35px',marginLeft:'60px'}}>Payout Information</p>

<div className='mt-3  row  ' style={{ marginLeft:'70px',marginRight:'80px'}} >
  <img className='text-center' src="https://res.cloudinary.com/djx3ijal6/image/upload/v1722796616/Vector_21_trejqe.png"/>
  <div className='col-auto me-3'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Account Name</p>
                <input
                  type="text"
                  placeholder="Nigeria"
              ...
              <div className='col-auto me-3'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Bank name</p>
                <input
                  type="text"
                  placeholder="Daniella willams"
              ...
              <div className='col-auto'>
                <p className='text-left pt-2' style={{ color: '#8de5bd', fontSize: '13px', marginBottom:'2px' }}>Account Number</p>
                <input
                  type="text"
                  placeholder="daniellawillams@gmail.com"
